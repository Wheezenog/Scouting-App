...
class TeleopScoutingPage extends StatefulWidget {
  static const routeName = '/Teleop_Scouting';
  const TeleopScoutingPage({super.key});

  @override
  State<TeleopScoutingPage> createState() => _TeleopScoutingPageState();
}

Logger log = Logger(printer: PrettyPrinter(methodCount: 0));

class _TeleopScoutingPageState extends State<TeleopScoutingPage> {
  @override
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          const Expanded(child: ScoutingButtonRow()),
          const Expanded(
              child: Row(
                  ...
                  child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.restorablePushNamed(
                            context, AutoScoutingPage.routeName);
                      },
                      child: const Padding(
                        padding: EdgeInsets.all(10),
                        child: Text(
